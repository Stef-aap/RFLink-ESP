...
//EXISTS TOEVOEGEN
  ...
  else if ( path.endsWith ( ".h"    )) dataType = "text/html"              ;
...
//Serial.println ( "ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ-" + Key + "-ZZ-" + My_Webserver.arg ( Key ) + "-Z-" +Value.as<String>() + "-" ) ;          
