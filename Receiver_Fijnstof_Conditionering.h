...
//Serial.println ( "Fijsntof: "+ My_Webserver.argName(i) ) ;        
        ...
        if      ( My_Webserver.argName(i) == "FSC Delay"  ) { if ( New_Value_Int != Delay  ) _My_Settings_Buffer [ "FSC Delay"  ] = New_Value_Int ; }
        else if ( My_Webserver.argName(i) == "FSC Tcool"  ) { if ( New_Value_Int != Tcool  ) _My_Settings_Buffer [ "FSC Tcool"  ] = New_Value_Int ; }
        else if ( My_Webserver.argName(i) == "FSC Theat"  ) { if ( New_Value_Int != Theat  ) _My_Settings_Buffer [ "FSC Theat"  ] = New_Value_Int ; }
        else if ( My_Webserver.argName(i) == "FSC RHcool" ) { if ( New_Value_Int != RHcool ) _My_Settings_Buffer [ "FSC RHcool" ] = New_Value_Int ; }
        else if ( My_Webserver.argName(i) == "FSC RHheat" ) { if ( New_Value_Int != RHheat ) _My_Settings_Buffer [ "FSC RHheat" ] = New_Value_Int ; }
        else if ( My_Webserver.argName(i) == "FSC Thyst"  ) { if ( New_Value_Int != Thyst  ) _My_Settings_Buffer [ "FSC Thyst"  ] = New_Value_Int ; }
        else if ( My_Webserver.argName(i) == "FSC RHhyst" ) { if ( New_Value_Int != RHhyst ) _My_Settings_Buffer [ "FSC RHhyst" ] = New_Value_Int ; }
      }
