...
class _Sensor_IR_Samsung_TV : public _Sensor_BaseClass {
  public:
    ...
    // Creators
    // ***********************************************************************
    _Sensor_IR_Samsung_TV ( int IR_LED, bool Inverted = true ) {
      IR_Transmitter = new IRsend ( IR_LED, Inverted ) ;
    }
    
    // ***********************************************************************
    // ***********************************************************************
    void   setup () {
      IR_Transmitter->begin () ;
    }
    ...
    void Send_IR ( unsigned long Data ) {
      IR_Transmitter->sendSAMSUNG ( Data, Samsung_TV_NBit ) ;
    }
