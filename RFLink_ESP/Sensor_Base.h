...
class _Sensor_BaseClass {
  public:
    ...
    // **********************************************************************************************
    virtual bool Check_Modified_Settings () {
      return false ;
    }
    ...
    // ***********************************************************************
    // ***********************************************************************
    virtual bool Handle_Serial_Command ( String Serial_Command ) {
	    return false ;
  	}
    ...
    // ***********************************************************************
    virtual void Set_Parameters ( int Sample_Time_msec ) {
    ...
    // ***********************************************************************
    virtual String Get_JSON_LuftData () {
      return "" ;
    } 
